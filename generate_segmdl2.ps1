...
$outputPath = "c:/Users/Toshiba/Desktop/LionX-Engine/app/src/main/jni/include/font_segmdl2.h"
...
[void]$sb.AppendLine("const unsigned char segmdl2_ttf[] = {")
...
[void]$sb.AppendLine("};")
[void]$sb.AppendLine("const unsigned int segmdl2_ttf_len = $len;")

Write-Host "Writing to $outputPath..."
[System.IO.File]::WriteAllText($outputPath, $sb.ToString())
Write-Host "Successfully generated font header at $outputPath!"
